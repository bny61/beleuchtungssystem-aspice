...
|---|---|---|---|---|---|---|---|
| CR-001 | functional | B | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-001.md` |
| CR-002 | functional | B | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-002.md` |
| CR-003 | functional | A | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-003.md` |
| CR-004 | functional | A | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-004.md` |
| CR-005 | functional | A | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-005.md` |
| CR-006 | functional | QM | draft | - | - | - | `01_requirements/customer/CR-006.md` |
| CR-007 | functional | B | reviewed | - | ECU_LightingCtrl | TC-021 | `01_requirements/customer/CR-007.md` |
| CR-008 | functional | B | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-008.md` |
...
| CR-016 | electrical | B | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-016.md` |
| CR-017 | electrical | B | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-017.md` |
| CR-018 | electrical | QM | draft | - | - | - | `01_requirements/customer/CR-018.md` |
| CR-019 | diagnostics | QM | draft | - | - | - | `01_requirements/customer/CR-019.md` |
| CR-020 | communication | B | draft | - | Item_LightingSystem | - | `01_requirements/customer/CR-020.md` |
| CR-021 | communication | QM | draft | - | - | - | `01_requirements/customer/CR-021.md` |
| CR-022 | durability | QM | draft | - | - | - | `01_requirements/customer/CR-022.md` |
...
| SM-01 | safety-mechanism | B | draft | FSR-001, TSR-003 | ECU_LightingCtrl, LED_Driver_Stage_1, Current_Sense_Chain | TC-021 | `05_hardware/SM-01.md` |
| SYS-REQ-001 | functional | B | draft | CR-001, FSR-002 | ECU_LightingCtrl, SWC_LightManager, LED_Driver_Stage_1 | - | `01_requirements/system/SYS-REQ-001.md` |
| SYS-REQ-002 | functional | B | draft | CR-002, FSR-002 | ECU_LightingCtrl, SWC_LightManager | - | `01_requirements/system/SYS-REQ-002.md` |
| SYS-REQ-003 | functional | B | draft | CR-002 | ECU_LightingCtrl, SWC_LightManager | - | `01_requirements/system/SYS-REQ-003.md` |
| SYS-REQ-004 | functional | A | draft | CR-003, FSR-005 | ECU_LightingCtrl, SWC_HighBeamControl | - | `01_requirements/system/SYS-REQ-004.md` |
| SYS-REQ-005 | functional | A | draft | CR-004, FSR-008 | ECU_LightingCtrl, SWC_WorkLampControl | - | `01_requirements/system/SYS-REQ-005.md` |
| SYS-REQ-006 | functional | A | draft | CR-005 | ECU_LightingCtrl, LED_Driver_Stage_1 | - | `01_requirements/system/SYS-REQ-006.md` |
| SYS-REQ-007 | functional | A | draft | CR-005 | ECU_LightingCtrl, LED_Driver_Stage_1 | - | `01_requirements/system/SYS-REQ-007.md` |
| SYS-REQ-008 | diagnostics | A | draft | CR-005 | ECU_LightingCtrl, SWC_LightManager | - | `01_requirements/system/SYS-REQ-008.md` |
| SYS-REQ-009 | functional | QM | draft | CR-006 | ECU_LightingCtrl, LED_Driver_Stage_1 | - | `01_requirements/system/SYS-REQ-009.md` |
| SYS-REQ-010 | functional | B | draft | CR-007, FSR-004 | ECU_LightingCtrl, Vehicle_Gateway | - | `01_requirements/system/SYS-REQ-010.md` |
| SYS-REQ-011 | functional | B | draft | CR-008, FSR-003 | ECU_LightingCtrl, LED_Driver_Stage_1 | - | `01_requirements/system/SYS-REQ-011.md` |
| SYS-REQ-012 | electrical | B | draft | CR-016, FSR-002 | ECU_LightingCtrl | - | `01_requirements/system/SYS-REQ-012.md` |
| SYS-REQ-013 | electrical | B | draft | CR-016, FSR-003 | ECU_LightingCtrl, LED_Driver_Stage_1 | - | `01_requirements/system/SYS-REQ-013.md` |
...
| SYS-REQ-020 | communication | B | draft | CR-020 | ECU_LightingCtrl, Vehicle_Gateway | - | `01_requirements/system/SYS-REQ-020.md` |
| SYS-REQ-021 | diagnostics | QM | draft | CR-019 | ECU_LightingCtrl | - | `01_requirements/system/SYS-REQ-021.md` |
| TC-021 | fault-injection | B | draft | SYS-REQ-014, SYS-REQ-018, FSR-001, SG-01 | HiL | - | `07_verification/testcases/TC-021.md` |
| TSR-001 | safety | B | draft | FSR-002 | ECU_LightingCtrl, ASIC_Watchdog | - | `02_safety/04_tsc/TSR-001.md` |
| TSR-002 | safety | B | draft | FSR-002 | ECU_LightingCtrl, SWC_LightManager, Current_Sense_Chain | - | `02_safety/04_tsc/TSR-002.md` |
| TSR-003 | safety | B | draft | FSR-001 | ECU_LightingCtrl, SM-01, SWC_LightManager | - | `02_safety/04_tsc/TSR-003.md` |
| TSR-004 | safety | B | draft | FSR-003, FSR-001 | ECU_LightingCtrl, SWC_LightManager, LED_Driver_Stage_1 | - | `02_safety/04_tsc/TSR-004.md` |
| TSR-005 | safety | B | draft | FSR-004 | ECU_LightingCtrl, Vehicle_Gateway | - | `02_safety/04_tsc/TSR-005.md` |
| TSR-006 | safety | QM(A) | draft | FSR-006 | SWC_HighBeamControl | - | `02_safety/04_tsc/TSR-006.md` |
| TSR-007 | safety | A(A) | draft | FSR-007 | ECU_LightingCtrl, SWC_HighBeamMonitor | - | `02_safety/04_tsc/TSR-007.md` |
| TSR-008 | safety | A | draft | FSR-008 | ECU_LightingCtrl, SWC_WorkLampControl | - | `02_safety/04_tsc/TSR-008.md` |
