...
| SYS.5 | ASPICE | System qualification test | system | right | id:TC- | 07_verification/reports/traceability_matrix.md |
...
| HWE.1 | ASPICE | Hardware requirements analysis | hardware | left | id:HW-REQ- | 05_hardware/analysis_current_sensing.md |
...
| Part 5 | ISO | Product development at hardware level | hardware | left | id:HW-REQ-, id:SM- | 05_hardware/hw_architecture.md, 05_hardware/hw_verification_plan.md |
